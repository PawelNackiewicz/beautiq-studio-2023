...
export default function Page() {
  return (
    <div className="flex gap-2 flex-col items-center max-w-3xl text-center">
       <Image
        ...
        <button className="text-white bg-black p-2 uppercase rounded-md">Zapisz sie na szkolenie</button>
    </div>
  )
}
